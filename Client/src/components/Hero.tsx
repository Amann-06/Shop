    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-center px-10">
        ...
        <div className="flex gap-3 mt-6">
          <button className="bg-indigo-600 text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-indigo-700 transition-colors">
            Shop now
          </button>
          <button className="border border-white/40 text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-indigo-100/10 transition-colors">
            Sell an item
          </button>
        </div>
      </div>
